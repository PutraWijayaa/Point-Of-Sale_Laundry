    ...
    <script>
        ...
        $('.add-row').click(function() {
            ...
            newRow += `<td>  ${service_name} <input class='form-control' type='hidden' value='${service_name}' name='service_name[]'>  </td>`;
            newRow += `<td>  ${service_price.toLocaleString()} <input class='form-control' type='hidden' name='subtotal[]' value='${price}' >  </td>`;
